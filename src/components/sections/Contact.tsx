        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl">
          {links.map((link, i) => (
            <motion.a
              ...
              className="group flex flex-col gap-4 p-5 rounded-xl border border-white/[0.07] hover:border-white/[0.15] bg-[#0f0f0f] hover:bg-[#131313] transition-all duration-200"
            >
              ...
              <div>
                ...
                <p className="font-mono text-xs text-white/30 group-hover:text-white/50 transition-colors">
                  {link.desc}
                </p>
              </div>
            </motion.a>
